...
namespace WzVisualizer.GUI {
    ...
    public partial class MainForm : Form {
        ...
        private void LoadWzData(WzMapleVersion encryption, string directory) {
            ...
            switch (selectedRoot) {
                ...
                case 9: // Pets
                {
                    ...
                    void AddRow(WzImage wz, DataViewer dv) => wz.WzProperties.ForEach(imgs => AddGridRow(dv.GridView, imgs));
        ...
        /// </summary>
        private async void BtnWzLoad_Click(object sender, EventArgs e) {
            DisposeWzFiles();
            ...
            if (item.Value == null) {
                ...
                if (File.Exists(wzStringPath + Resources.FileExtensionWZ)) {
                    ...
                    encryption = WzMapleVersion.EMS; // welp, no auto-detect for this
                }
                else {
        ...
        private void OnTabControlChanged() {
            ...
            var main = TabControlMain.SelectedTab;
            var sub = (main.Controls[0] is TabControl tc ? tc.SelectedTab : main);
            WzVisualizer.IO.BinaryDataUtil.ImportGrid($"{main.Text}/{sub.Text}.bin", (DataViewer) sub.Controls[0], AddGridRow);
        }
